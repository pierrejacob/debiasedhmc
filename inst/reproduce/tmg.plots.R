...
g
ggsave(filename = "tmg.dist1.png", plot = g, width = 7, height = 6)
...
ghist1
ggsave(filename = "tmg.meetingtimes1.pdf", plot = ghist1, width = 7, height = 6)
...
g <- g + xlab(expression(x[1])) + ylab(expression(x[2])) + theme(legend.position = "none")
g
ggsave(filename = "tmg.dist2.png", plot = g, width = 7, height = 6)
...
ghist2
ggsave(filename = "tmg.meetingtimes2.pdf", plot = ghist1, width = 7, height = 6)
