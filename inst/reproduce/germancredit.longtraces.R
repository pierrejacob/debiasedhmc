...
for (irep in 1:nrep){
  ...
  save(nmcmc, effectiveTimes, nsteps, hmctraces, nrep, file = "germancredit.hmclongtraces.RData")
}
load(file = "germancredit.hmclongtraces.RData")
