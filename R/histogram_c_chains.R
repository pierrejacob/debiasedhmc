...
#'@param c_chains list containing pairs of chains generated by \code{\link{coupled_chains}}
#'@param component index of the desired marginal distribution
#'@param k tuning parameter representing 'burn-in'
#'@param K tuning parameter representing 'total number of iteration per estimator'
#'@param breaks vector of breaks (default to NULL)
#'@param nclass desired number of classes; either specify this or \code{breaks} (default to 30)
#'@export
...
#'@description Plot histograms produced by \code{\link{histogram_c_chains}}.
#'@param histogram list resulting from \code{\link{histogram_c_chains}}
#'@param with_bar boolean specifying whether to plot vertical bars for point estimates,
#'or only grey rectangles for confidence intervals.
#'@export
